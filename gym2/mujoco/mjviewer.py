...
from .generated import const
from .utils import rec_copy, rec_assign
import ..cythonized as cymj
...
class MjViewer(MjViewerBasic):
    ...
    def _create_full_overlay(self):
        ...
        self.add_overlay(const.GRID_BOTTOMRIGHT, "timestep",
                         "%.5f" % self.sim.model.opt.timestep)
        self.add_overlay(const.GRID_BOTTOMRIGHT, "n_substeps",
                         str(self.sim.nsubsteps))
        self.add_overlay(const.GRID_TOPLEFT,
